...
<body>
    ...
    <div style="" id="qui-sommes-nous">
        <div class="align-center" style="text-align: center;">
            ...
            <div class="justify-content-center" id="container-modal">
                <button id="button-devis" type="button" class="btn btn-outline " data-toggle="modal"
                    data-target="#form-contact-mail">
                    <b>Nous contacter</b>
                </button>
                <!-- Modal -->
                <div class="modal fade" id="form-contact-mail" tabindex="-1" role="form" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <h5 class="modal-title" id="ModalLabel">
                                <b>Formulaire de <br>contact</b>
                            </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                                    ...
                                    <div class="form-group">
                                        <label class="form-group has-float-label">
                                            <textarea class="form-control" id="mail-content" name="mail-content"
                                                aria-describedby="phone" required></textarea>
                                            <span style="background-color:white;font-size: 15px">Contenu du mail</span>
                                        </label>
                                    </div>
