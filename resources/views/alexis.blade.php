    ...
    <nav class="navbar fixed-top navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse " id="navbarsExample07XL">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/alexis">Contact</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container" style="margin-top: 100px; height:100vh">
        <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Alexis Lefoul">
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">Adresse mail</label>
              <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="alexis.lefoul@gmail.com">
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">Numéro de téléphone</label>
              <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="07 01 02 03 04">
            </div>
            <div class="form-group">
              <label for="formGroupExampleInput2">Message</label>
              <textarea type="text" class="form-control" id="formGroupExampleInput2" placeholder="Votre message..."></textarea>
            </div>
