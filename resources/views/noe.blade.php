...
<body>
  ...
  <div class="marginTop d-flex align-items-center justify-content-center">
    <form>
      <
 div class=" form-group">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="exampleFormControlTextarea1" cols="30" rows="5"></textarea>
      </div>
